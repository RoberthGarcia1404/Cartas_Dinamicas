...
async function shortenUrl(longUrl) {
    try {
        ...
        throw error; // Re-lanzamos el error para manejarlo después
    }
}
...
shareButton.addEventListener('click', async () => {
    ...
    try {
        ...
        // Copiar enlace corto al portapapeles
        ...
        try {
            ...
            console.error("Error al copiar enlace largo:", copyError);
...
// Cargar datos desde URL al iniciar la aplicación
loadFromUrl();
